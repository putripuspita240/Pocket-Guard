...
<head>
    ...
    <title>Pocket Guard- Dashboard</title>
...
<body>
    <div class="header">
        ...
        <h3 class="text-secondary font-weight-bold float-left logo">Pocket Guard</h3>
        <a href="logout">
            <div class="logout">
                                ...
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center tulisan">
                                            <div class="numbers">
                                                <p class="card-category ket head">Saldo Pocket Guard </p>
