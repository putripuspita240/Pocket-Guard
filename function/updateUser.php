...
if ($status == 'tidak aktif') {
    $name = 'Admin Pocket Guard';
    $subject = 'Penonaktifan Akun Pocket Guard';
    ...
    // More headers
    $headers .= 'From: Pocket Guard <noreply@dompetqu.com>'."\r\n" . 'Reply-To : '.$name.' <'.$email.'>'."\r\n";
...
elseif($status == 'aktif') {
    $name = 'Admin Pocket Guard';
    $subject = 'Pengaktifan Akun Pocket Guard';
    $message = '<p style="text-align: center">Selamat suadara/i <b>'.$username.'!</b>, 
                ...
                <h3 style="text-align: center"><b>atas waktunya, kami ucapkan terimakasih!</b></h3>
                <a style="text-align: center" href="http://dompetqu.000webhostapp.com" target="_blank">Gunakan Pocket Guard</a>';
